...
\input{../journal/tables/table1_ablation}
...
\input{../journal/tables/table2_correlation}
...
\input{../journal/tables/table3_inter_metric}
...
\input{../journal/tables/table4_perplexity_comparison}
...
\input{../journal/tables/table5_scaling}
...
We evaluate the SWAN-quantized Qwen3.5-397B (199\,GB, 4.31 avg bits with v2 metrics) on standard academic benchmarks with greedy decoding and thinking disabled:
...
\input{../journal/tables/table2_correlation_qwen3_8b}
...
All code and data are available at [anonymized]. Experiments use:
\begin{itemize}
